...
const StatCard: React.FC<{
  ...
  <div className="bg-layer2 border border-white rounded-xl  p-4 hover:shadow-md transition-all duration-300">
 
    <div className="flex flex-col  justify-between">
      <div className=' flex items-center gap-2 mb-4'>
        <div className=" w-12 h-12 flex justify-center items-center rounded-xl bg-gray-100">
          {icon}
        </div>
...
const SaleAnalyticChart: React.FC = () => {
  ...
  return (
    <div className=" bg-gradient-to-br" style={{maxHeight:'540px'}}>
        ...
        <div className="bg-layer2 rounded-4xl border border-white   p-4">
          ...
          <div className="flex items-center  gap-3 flex-wrap">
            ...
            <button
              ...
              className="p-3 bg-layer3 rounded-3xl  border border-white  hover:bg-gray-50 transition-colors"
            >
