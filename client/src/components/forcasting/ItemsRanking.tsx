                        ...
                        >
                            <div className="px-4 py-4 md:px-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    {/* Image */}
                                    <div className="flex-shrink-0 w-16 h-16 flex items-center justify-center rounded-lg overflow-hidden bg-gray-100">
                                        {item.image_url ? (
                                            <img
                                    ...
                                    {selectedItem && (
                                        <>
                                            ...
                                            <div className="relative bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
                                                ...
                                                >
                                                    <XMarkIcon className="w-6 h-6 shadow-2xl" />
                                                </button>
                                                
                                                <div className="flex items-center gap-4">
                                                    <div className={`p-4 rounded-xl shadow-2xl border-2 border-white/30 ${getRankColor(selectedItem.sales_rank)}`}>
                                                        {getRankIcon(selectedItem.sales_rank)}
                                                    </div>
                                                    <div>
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="mt-6 bg-gray-50 rounded-xl p-2">
                                                    <div className="flex items-center gap-2 mb-3">
                                                ...
                                                <div className="mt-4 flex items-center justify-between text-xs text-gray-400 border-t border-gray-200 pt-4">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <span>Total Orders: {selectedItem.total_orders}</span>
                                                    </div>
                                                    <div className="flex items-center gap-4">
